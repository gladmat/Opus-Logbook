...
- **Multi-Region Recipient Site + X-ray Photo Enhancement COMPLETE (2026-07-30)** — Branch `feature/multiregion-xray-enhance` (6 commits, NOT yet merged to main at time of writing). Two on-device friction reports; tests 2299 → 2336 across 145 files; tsc/lint/prettier clean; both features sim-verified E2E on the freshly rebuilt dev client.

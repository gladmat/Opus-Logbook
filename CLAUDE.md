...
- **Multi-Region Recipient Site + X-ray Photo Enhancement COMPLETE (2026-07-30)** — Branch `feature/multiregion-xray-enhance` (11 commits incl. the same-day follow-up wave below, NOT yet merged to main at time of writing). Two on-device friction reports; tests 2299 → 2353 across 145 files; tsc/lint/prettier clean; all features sim-verified E2E on the freshly rebuilt dev client.

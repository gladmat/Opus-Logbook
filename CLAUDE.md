...
- **Version:** 2.5.1, buildNumber 9 (app.json) — EAS assigns remote buildNumber (e.g. 1.2.52) because `eas.json` has `appVersionSource: "remote"` + production `autoIncrement: true`

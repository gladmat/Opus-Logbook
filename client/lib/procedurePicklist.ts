...
const HEAD_NECK_FREE_FLAPS: ProcedurePicklistEntry[] = [
  ...
  },
  {
    ...
    snomedCtCode: "1204100003",
    snomedCtDisplay: "Vascularised bone graft with microsurgery",
    specialties: ["head_neck", "orthoplastic", "hand_wrist"],
    subcategory: "Free Flap — Bone",
    tags: ["free_flap", "microsurgery"],
    hasFreeFlap: true,
    sortOrder: 4,
  },

...
const HAND_DX_FRACTURES: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    suggestedProcedures: [
      ...
      {
        procedurePicklistId: "hand_fx_metacarpal_orif_ccs",
  ...
  },
  {
    ...
    suggestedProcedures: [
      ...
      {
        procedurePicklistId: "hand_fx_phalanx_orif_ccs",
  ...
  },
  {
    ...
    suggestedProcedures: [
      ...
      {
        procedurePicklistId: "hn_ff_medial_femoral_condyle",
        displayName: "Free MFC flap (vascularised bone graft)",
        isDefault: false,
        isConditional: true,
        conditionDescription: "Proximal pole AVN or prior failed grafting",
        sortOrder: 2,
      },
      {
  ...
  },
  {
    ...
    suggestedProcedures: [
      ...
      {
        procedurePicklistId: "hand_fx_carpal_crif_ccs",
...
const HAND_DX_TENDON_INJURIES: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    suggestedProcedures: [
      {
        procedurePicklistId: "hand_fx_mallet_extension_block",
        displayName: "Extension block K-wire fixation (Ishiguro)",
        isDefault: true,
        sortOrder: 1,
      },
      {
        procedurePicklistId: "hand_tend_mallet_finger",
        displayName: "Mallet finger splinting / repair",
        isDefault: false,
        sortOrder: 2,
      },
      {
        procedurePicklistId: "hand_fx_phalanx_crif",
        displayName: "Transfixion K-wire (CRIF)",
        isDefault: false,
        sortOrder: 3,
      },
      {
        procedurePicklistId: "hand_fx_phalanx_orif",
        displayName: "Screw ORIF (large fragment)",
        isDefault: false,
        sortOrder: 4,
      },
    ],
...
const HAND_DX_JOINT: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    suggestedProcedures: [
      {
        procedurePicklistId: "hn_ff_medial_femoral_condyle",
        displayName: "Free MFC flap (vascularised bone graft to lunate)",
        isDefault: false,
        isConditional: true,
        conditionDescription:
          "Early-stage Kienböck's (Lichtman II / IIIA) with preserved carpal architecture",
        sortOrder: 1,
      },
      {
        procedurePicklistId: "hand_joint_prc",
  ...
  },
  {
    ...
    suggestedProcedures: [
      ...
      },
      {
        ...
        displayName: "Pedicled vascularised bone graft (1,2 ICSRA)",
        isDefault: false,
        isConditional: true,
      ...
      },
      {
        ...
        isDefault: false,
        isConditional: true,
        conditionDescription: "Proximal pole AVN or prior failed pedicled VBG",
        sortOrder: 3,
      },
    ],
    sortOrder: 12,
...
const HAND_DX_OTHER: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    snomedCtDisplay: "Enchondroma of hand bone (disorder)",
    specialty: "hand_wrist",
    subcategory: "Tumours & Other",
    clinicalGroup: "elective",
    hasStaging: false,
